...
aws cloudformation update-stack --stack-name myecsstack --template-body file:///$PWD/ecs.yml --parameters ParameterKey=SubnetID,ParameterValue=subnet-e58fafa9 --capabilities CAPABILITY_NAMED_IAM
